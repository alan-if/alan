...
static lmMsgs msg[] = {
    ...
    { "325   ", "Cannot use transitivity (\'%1\') with IN operating on a SET." },
    ...
    { "451   ", "Filter using IN transitively can possibly return instances of any type. If this is not what you want use \'Directly In\' instead. To silence this warning use an explict transitivity." },

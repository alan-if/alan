...
static lmMsgs msg[] = {
    ...
    { "101   ", "Syntax error. Inserting tokens: %1" },
    { "102   ", "Syntax error. Ignoring tokens: %1" },
    { "103   ", "Syntax error. Replacing tokens: %1 with: %2" },
    ...
    { "316   ", "Attribute \'%1\' is not defined for %2 \'%3\' since the class (\'%4\') does not have it." },
    ...
    { "410   ", "Incompatible types in %1. Set can only contain %2." },
    ...
    { "429   ", "No inheritance defined, everything must inherit from a class." },

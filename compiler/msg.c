...
static struct {int messageCode; char *id; char *english; char *swedish; char *german;} defmsg[] =
    {
        ...
        {M_WHAT, "what",
         ...
         "Jag f\xF6rst\xE5r inte det där.",
         "Ich ferste nicht."},
        {M_WHAT_WORD, "what_word",
         "I don't understand what you mean by '$1'.",
         "Jag förstår inte vad du menar med '$1'.",
        ...
        {M_AFTER_BUT, "after_but",
         ...
         "Jag förväntade mig åtminstone ett objekt efter '$1'.",
        ...
        {M_WHICH_ONE_START, "which_start",
         "I'm not sure if you mean $+1",
         "Jag är inte säker på om du menar $+1",
         "Ich verstehe nicht, falls Du $+1"},
        ...
        {M_SAVEOVERWRITE, "save_overwrite",
         "A file with that name exists, overwrite (RETURN confirms) ? ",
         "Det finns en fil med det namnet, skriva \xF6ver (tryck RETUR f\xF6r ja) ? ",
         "Ein Datei mit dieser name existiert, überschreiben (ENTER, best\xE4tigt)? "},
        ...
        {M_WHICH_PRONOUN_START, "which_pronoun_start",
         "I'm not sure whether by '$1' you mean",
         "Jag förstår inte om du med '$1' menar",
         "Ich versthe nicht, ob du mit '$1'"},
        {M_WHICH_PRONOUN_FIRST, "which_pronoun_first",
         "$+1",
         "$+1",
         "$+1"},
        /* Uses M_WHICH_ONE_COMMA and M_WHICH_ONE_OR also for pronoun messages */
        ...
        {M_CONTAINMENT_LOOP2, "containment_loop2",
         "It is impossible to put $+1 in $+2 because $+2 is already inside $+1.",

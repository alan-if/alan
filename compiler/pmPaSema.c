...
#line 1863 "alan.pmk"
    	...
    	break;}
    case 249: { /* <repetition_statement> = <for_each> ID <optional_loop_restrictions> 'DO' <statements> 'END' <for_each> __genSym#13; */
#line 1873 "alan.pmk"
	...
	pmSeSt[pmStkP+1].stm->fields.each.filters = pmSeSt[pmStkP+3].exps;
    	break;}
    case 252: { /* <optional_loop_restrictions> =; */
#line 1884 "alan.pmk"

	pmSeSt[pmStkP+1].exps = NULL;
	pmSeSt[pmStkP+1].id = NULL;
    	break;}
    case 253: { /* <optional_loop_restrictions> = <filters>; */
#line 1890 "alan.pmk"
...
#line 2102 "alan.pmk"
 { Expression *exp;
    ...
    case 281: { /* <arithmetic> = <aggregate> <filters>; */
#line 2113 "alan.pmk"
...
#line 2154 "alan.pmk"
 { Expression *exp;
    ...
    case 289: { /* <filter expression> = <optional_not> 'ISA' ID; */
#line 2163 "alan.pmk"
	...
	pmSeSt[pmStkP+1].id = pmSeSt[pmStkP+3].id;
    	break;}
    case 290: { /* <filter expression> = <is> <something>; */
#line 2170 "alan.pmk"
	...
	pmSeSt[pmStkP+1].exp = newAttributeExpression(pmSeSt[pmStkP+1].srcp,
        ...
        pmSeSt[pmStkP+1].expKd = ATTRIBUTE_EXPRESSION;
    	break;}
    case 292: { /* <right_hand_side> = <optional_not> <relop> <primary>; */
#line 2179 "alan.pmk"
 { Expression *exp;
        pmSeSt[pmStkP+1].expKd = BINARY_EXPRESSION;
	exp = newExpression(&pmSeSt[pmStkP+2].srcp, BINARY_EXPRESSION);
    ...
    case 294: { /* <right_hand_side> = <optional_not> 'BETWEEN' <factor> 'AND' <factor>; */
#line 2189 "alan.pmk"
 { Expression *exp;
        pmSeSt[pmStkP+1].expKd = BETWEEN_EXPRESSION;
    ...
    case 293: { /* <right_hand_side> = <optional_not> 'CONTAINS' <factor>; */
#line 2199 "alan.pmk"
 { Expression *exp;
        pmSeSt[pmStkP+1].expKd = BINARY_EXPRESSION;
	exp = newExpression(&pmSySt[pmStkP+2].srcp, BINARY_EXPRESSION);
    ...
    case 299: { /* <primary> = '(' <expression> ')'; */
#line 2214 "alan.pmk"

	pmSeSt[pmStkP+1].exp = pmSeSt[pmStkP+2].exp;
    	break;}
    case 295: { /* <primary> = <optional_minus> Integer; */
#line 2219 "alan.pmk"
...
#line 2228 "alan.pmk"
	...
	pmSeSt[pmStkP+1].exp->fields.str.len = pmSySt[pmStkP+1].len;
    	break;}
    case 297: { /* <primary> = <what>; */
#line 2235 "alan.pmk"

	pmSeSt[pmStkP+1].exp = pmSeSt[pmStkP+1].exp;
    	break;}
    case 300: { /* <primary> = 'RANDOM' <primary> 'TO' <primary>; */
#line 2240 "alan.pmk"
...
#line 2452 "alan.pmk"
	...
	pmSeSt[pmStkP+1].srcp = pmSySt[pmStkP+1].srcp;
    	break;}
    case 332: { /* <optional_qual> =; */
#line 2462 "alan.pmk"

        pmSeSt[pmStkP+1].qual = QUAL_DEFAULT;
    	break;}
    case 333: { /* <optional_qual> = 'BEFORE'; */
#line 2467 "alan.pmk"

        pmSeSt[pmStkP+1].qual = QUAL_BEFORE;
        pmSeSt[pmStkP+1].srcp = pmSySt[pmStkP+1].srcp;
    	break;}
    case 334: { /* <optional_qual> = 'AFTER'; */
#line 2473 "alan.pmk"

        pmSeSt[pmStkP+1].qual = QUAL_AFTER;
        pmSeSt[pmStkP+1].srcp = pmSySt[pmStkP+1].srcp;
    	break;}
    case 335: { /* <optional_qual> = 'ONLY'; */
#line 2479 "alan.pmk"

        pmSeSt[pmStkP+1].qual = QUAL_ONLY;
        pmSeSt[pmStkP+1].srcp = pmSySt[pmStkP+1].srcp;
    	break;}
    case 336: { /* <optional_not> =; */
#line 2488 "alan.pmk"

        pmSeSt[pmStkP+1].not = FALSE;
    	break;}
    case 337: { /* <optional_not> = 'NOT'; */
#line 2493 "alan.pmk"

        pmSeSt[pmStkP+1].not = TRUE;
    	break;}
    case 338: { /* <optional_id> =; */
#line 2500 "alan.pmk"

        pmSeSt[pmStkP+1].id = NULL;
    	break;}
    case 339: { /* <optional_id> = ID; */
#line 2505 "alan.pmk"

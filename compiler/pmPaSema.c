...
#line 2064 "alan.pmk"
	...
	pmSeSt[pmStkP+1].exp = newBinaryExpression(pmSeSt[pmStkP+3].srcp,
					    ...
					    pmSeSt[pmStkP+4].exp);
    	break;}
    case 279: { /* <factor> = <factor> <optional_not> <optional_directly> <where>; */
#line 2073 "alan.pmk"
...
#line 2144 "alan.pmk"
    	...
    	break;}
    case 291: { /* <filter expression> = <optional_not> <optional_directly> <where>; */
#line 2167 "alan.pmk"
